    ...
    for line in f:
        ...
        if(random.random()>0.2):
            ...
            if hasmag:
                ...
                for i in range(1):
                    x[-1].append(float(attributes[i]))
            y.append(int(float(attributes[-1])))
        else:
            testx.append([])
            if hasmag:
                for i in range(1):
